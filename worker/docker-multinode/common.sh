...
#  LATEST_STABLE_K8S_VERSION=v1.5.1
...
kube::multinode::start_flannel() {
  ...
  # Load the flannel docker image to avoid connect to outside Internet
  # docker ${BOOTSTRAP_DOCKER_PARAM} load -i /root/flannel.docker
